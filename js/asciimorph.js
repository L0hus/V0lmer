...
var AsciiMorph = (function() {
  ...
  var element = document.querySelector('pre.morph-section')
  AsciiMorph(element, {x: 51,y: 28});
  
  var asciis = [[
  "   .S       S.     sSSs   .S       S.    .S_sSSs    sdSS_SSSSSSbs",
  "  .SS       SS.   d%%SP  .SS       SS.  .SS~YS%%b   YSSS~S%SSSSSP", 
  "  S%S       S%S  d%S'    S%S       S%S  S%S   `S%b       S%S",       
  ...
  "  S*b       d*S     l*S  S*b       d*S  S*S   `S%b       S*S",       
  "  S*S.     .S*S    .S*P  S*S.     .S*S  S*S    S%S       S*S",       
  "   SSSbs_sdSSS   sSS*S    SSSbs_sdSSS   S*S    S&S       S*S",       
  "    YSSP~YSSY    YSS'      YSSP~YSSY    S*S    SSS       S*S",       
  "                                        SP               SP",        
  "                                        Y                Y"   
  ],
